    ...
    class FluidSimulation {
        public:
            FluidSimulation(const FluidParams& params) {
                ...
                res_norm_over_it_with_pressure_solver = VectorXd::Zero(1e6);
                res_norm_over_it_without_pressure_solver = VectorXd::Zero(1e6);
                res_norm_over_time = VectorXd::Zero(1e6);
                n_cg_over_it = VectorXd::Zero(1e6);
