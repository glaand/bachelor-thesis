    ...
    : argument_parser(name)
{
    ...
    this->argument_parser.add_argument("-k", "--kmax").help("kmax").default_value(this->kmax).action([](const std::string& value) { return std::stoi(value); }); // 3D
    ...
    this->argument_parser.add_argument("-z", "--zlength").help("zlength").default_value(this->zlength).action([](const std::string& value) { return std::stod(value); }); // 3D
    this->argument_parser.add_argument("-t", "--t_end").help("t_end").default_value(this->t_end).action([](const std::string& value) { return std::stod(value); });
